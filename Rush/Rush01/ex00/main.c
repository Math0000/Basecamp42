...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/29 17:25:34 by mmoreira          #+#    #+#             */
/*   Updated: 2020/11/30 03:10:19 by mmoreira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char *argv[])
{
	...
	while (i < 4)
	{
		if (vetor[i] + vetor[i+4] < 3 || vetor[i] + vetor[i+4] > 5)
		{
			erro();
			return(0);
		}
		else if (vetor[i+8] + vetor[i+12] < 3 || vetor[i+8] + vetor[i+12] > 5)
		{
			erro();
			return(0);
		}
